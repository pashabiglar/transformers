...
class StudentTeacherTrainer:
    ...
    def train_multiple_teachers_1student(self, model_path: Optional[str] = None):
        ...
        #todo:ideally this must be created in the init of the Trainer class as self.list_all_models
        list_all_models=[]
        train_dataloader = self.get_train_dataloader_for_parallel_datasets()
        if self.args.max_steps > 0:
            t_total = self.args.max_steps
        ...
        for epoch in train_iterator:
            ...
            for step, (input_model1, input_model2, input_model3) in enumerate(epoch_iterator):
                ...
                if steps_trained_in_current_epoch > 0:
                    steps_trained_in_current_epoch -= 1
                    continue
                assert input_model1['labels'].tolist() == input_delex['labels'].tolist()
                ...
                for index,each_model in enumerate(list_all_models):
                    # model returns # (loss), logits, (hidden_states), (attentions)
                ...
                # consistency loss is calculated between logits of student model(model 1) and logits of other models
                ...
                #overall loss is a weighteed sum of classification and consistency loss
                ...
                #this is used mainly for printing purposes
                tr_loss_lex_float += tr_classification_loss.item()
                tr_loss_delex_float += tr_loss_delex.item()
