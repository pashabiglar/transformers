...
def run_loading_and_testing(model_args, data_args, training_args):
    ...
    model_path="./huggingface_bert_tuning_delex_from_inside_student_teacher_seed726/output/fever/fevercrossdomain/combined/figerspecific/bert-base-cased/128/pytorch_model_fe6c83.bin"
