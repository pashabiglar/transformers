...
def run_loading_and_testing(model_args, data_args, training_args):
    ...
    #url = 'https://osf.io/4ag8q/download' #trained_model_lex_helpful_vortex_1002_trained_model_afterepoch1_accuracy70point21percent..bin

    url = 'https://osf.io/96czs/download' #an experimental version of model lex trained sweet water 1001 since am not able to find the right model..atleast not at the right epoch.bin
