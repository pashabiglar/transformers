...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        wandb on
        wandb online
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/fever2fnc_group_learning_bert_base_uncased_lr1e5_class_loss_weight_0875_randomseed_8/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/fever2fnc_group_learning_bert_base_uncased_lr1e5_class_loss_weight_0875_randomseed_8/data"
fi
