...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        wandb on
        wandb online
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/fnc2fever_lexStandAlone_base_uncased_rs3082/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/fnc2fever_lexStandAlone_base_uncased_rs3082/data"
fi
