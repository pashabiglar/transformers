...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        wandb on
        wandb online
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/group_learning_fewshot_1percent/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/group_learning_fewshot_1percent/data"
fi
