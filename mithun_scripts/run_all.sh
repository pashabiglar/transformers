...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        wandb on
        wandb online
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/lexStandAlone_fever2fnc_bert_large_cased/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/lexStandAlone_fever2fnc_bert_large_cased/data"
fi
...
export BERT_MODEL_NAME="bert-large-cased" #options include things like [bert-base-uncased,bert-base-cased , minibert(google/bert_uncased_L-12_H-128_A-2)] etc. refer src/transformers/tokenization_bert.py for more.
