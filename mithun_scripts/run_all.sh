...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        wandb on
        wandb online
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/fever2fnc_group_learning_bert_base_uncased_classloss_weight10_lr1e_5/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/fever2fnc_group_learning_bert_base_uncased_classloss_weight10_lr1e_5/data"
fi
...
--overwrite_cache --total_no_of_models_including_student_and_its_teachers 4 --total_no_of_test_datasets 4 --do_train_student_teacher --classification_loss_weight 10"
