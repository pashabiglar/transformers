...
if [ $MACHINE_TO_RUN_ON == "hpc" ]; then
        wandb on
        wandb online
        export OUTPUT_DIR_BASE="/home/u11/mithunpaul/xdisk/factverification_v2/output"
        export DATA_DIR_BASE="/home/u11/mithunpaul/xdisk/factverification_v2/data"
fi
...
--task_type $TASK_TYPE --machine_to_run_on $MACHINE_TO_RUN_ON --toy_data_dir_path $TOY_DATA_DIR_PATH  --overwrite_cache --total_no_of_models_including_student_and_its_teachers 1 --total_no_of_test_datasets 1"
