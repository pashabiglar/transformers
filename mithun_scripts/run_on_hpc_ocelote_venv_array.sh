...
export PYTHONPATH="/home/u11/mithunpaul/xdisk/huggingface_bert_fever_to_fnc_load_studentteacher/code/src"
...
cd /home/u11/mithunpaul/xdisk/huggingface_bert_fever_to_fnc_load_studentteacher/code/examples

pip install -r requirements.txt
pip install transformers
pip install wget

cd /home/u11/mithunpaul/xdisk/huggingface_bert_fever_to_fnc_load_studentteacher/code/mithun_scripts
