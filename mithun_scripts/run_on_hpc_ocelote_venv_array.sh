...
export PYTHONPATH="/home/u11/mithunpaul/xdisk/huggingface_bert_fever_to_fnc_attention_weights_branch_loading_lex_trained_model_no_stop_words/code/src"
...
cd /home/u11/mithunpaul/xdisk/huggingface_bert_fever_to_fnc_attention_weights_branch_loading_lex_trained_model_no_stop_words/code/examples

pip install -r requirements.txt
pip install transformers
pip install wget

cd /home/u11/mithunpaul/xdisk/huggingface_bert_fever_to_fnc_attention_weights_branch_loading_lex_trained_model_no_stop_words/code/mithun_scripts
