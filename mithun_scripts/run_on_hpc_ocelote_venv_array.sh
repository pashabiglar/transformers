...
export PYTHONPATH="/home/u11/mithunpaul/xdisk/huggingface_bert_ema/code/src"
export CUDA_VISIBLE_DEVICES=0

pip install --upgrade pip

   
cd /home/u11/mithunpaul/xdisk/huggingface_bert_ema/code/examples

pip install -r requirements.txt
pip install transformers
pip install wget

cd /home/u11/mithunpaul/xdisk/huggingface_bert_ema/code/mithun_scripts
