...
#PBS -N tune_bert_max_seq_length
...
export PYTHONPATH="/home/u11/mithunpaul/xdisk/huggingface_bert_tuning_seq_length/code/src"
export CUDA_VISIBLE_DEVICES=0

pip install --upgrade pip

   
cd /home/u11/mithunpaul/xdisk/huggingface_bert_tuning_seq_length/code/examples

pip install -r requirements.txt
pip install transformers
pip install wget

cd /home/u11/mithunpaul/xdisk/huggingface_bert_tuning_seq_length/code/mithun_scripts
