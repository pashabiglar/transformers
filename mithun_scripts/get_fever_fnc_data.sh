...
if test -f "$FILE";then
    ...
    tail -4091 cross_domain_train1.tsv >> $FILE
...
if test -f "$FILE";then
    ...
    tail -4091 cross_domain_train2.tsv >> $FILE
...
if test -f "$FILE";then
   ...
   wget https://osf.io/uwcxs/download -O $FILE
    ...
    tail -4091 cross_domain_train3.tsv >> $FILE
...
if test -f "$FILE";then
   ...
   wget https://osf.io/mauqv/download -O $FILE
    ...
    tail -4091 cross_domain_train4.tsv >> $FILE
